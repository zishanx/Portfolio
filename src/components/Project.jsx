        ...
        <div id="project" className="section project">
            ...
            <div className="projects">
                ...
                >
                    ...
                    <img className="feat-img" src={image} alt="Project image" />
                </motion.div>
                <motion.div
                    className="pro-cards"
                    initial={{ opacity: 0, x: -20 }}
                ...
                >
                    ...
                    <div className="tags">
                        <span className="tag">REACT</span><span className="tag">API</span><span className="tag">NETLIFY</span>
                    </div>
                </motion.div>
                <motion.div
                    className="pro-cards"
                ...
                >
                    ...
                    <div className="tags">
                        <span className="tag">REACT</span><span className="tag">GITHUB</span>
                    </div>
                </motion.div>
            </div>
        </div >
